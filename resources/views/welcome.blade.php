    ...
    <body>
        <div class="container">
            <div class="servizio">
                ...
                <div class="sezione1">
                    <div class="sezione1-container">
                        <div class="title">
                            Sezione 1 lorem ipsum dolor sit amet.
                        </div>
                        <div class="subtitle">
                    ...
                    <div class="sezione1-spacer"></div>
                </div>
                <div class="scroll-container">
                    <img src="{{ asset('/img/Scroll.svg') }}" />
                </div>
            </div>
           <div class="sezione2-container">
                <div class="sezione2">
                    <img src="{{ asset('/img/modulo/text/cta/img/img.png') }}" />
                    <div class="sezione2 text-container">
                       <div class="sezione2 text-wrapper">
                       <div class="sezione2 title">
                        Sezione 2 sed do: 
                        quis nostrud exercitation
                        </div>
                        <div class="sezione2 subtitle">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.
                        </div>
                        <div class="sezione2 text">
                        Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit
